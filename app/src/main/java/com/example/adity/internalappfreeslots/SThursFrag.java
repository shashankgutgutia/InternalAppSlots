...
public class SThursFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootview=inflater.inflate(R.layout.sthursfrag,container,false);
        recyclerView1= (RecyclerView) rootview.findViewById(R.id.srthurs);
        recyclerView2= (RecyclerView) rootview.findViewById(R.id.srthurs2);
        recyclerView3= (RecyclerView) rootview.findViewById(R.id.srthurs3);
        recyclerView4= (RecyclerView) rootview.findViewById(R.id.srthurs4);
    ...
    private List<FreeSlotItem> getData(int n){
        ...
        switch (n) {
            case 1:
                ...
                break;
            case 2:
                names = new String[]{"Allan", "First Last Name", "First Last Name", "First Last Name", "First Last Name"};
                break;
            case 3:
                names = new String[]{"Allan", "Shashank", "First Last Name", "First Last Name", "First Last Name"};
                break;
            case 4:
