...
public class TueFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootview=inflater.inflate(R.layout.tuefrag,container,false);
        recyclerView1= (RecyclerView) rootview.findViewById(R.id.rtue);
        recyclerView2= (RecyclerView) rootview.findViewById(R.id.rtue2);
        recyclerView3= (RecyclerView) rootview.findViewById(R.id.rtue3);
        recyclerView4= (RecyclerView) rootview.findViewById(R.id.rtue4);
    ...
    private List<FreeSlotItem> getData(int n){
        ...
        switch (n) {
            ...
            case 2:
                ...
                break;
            case 3:
                names = new String[]{"Geetanjali", "Shashank", "Geetanjali", "First Last Name", "First Last Name"};
                break;
            case 4:
