...
public class STueFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootview=inflater.inflate(R.layout.stuefrag,container,false);
        recyclerView1= (RecyclerView) rootview.findViewById(R.id.srtue);
        recyclerView2= (RecyclerView) rootview.findViewById(R.id.srtue2);
        recyclerView3= (RecyclerView) rootview.findViewById(R.id.srtue3);
        recyclerView4= (RecyclerView) rootview.findViewById(R.id.srtue4);
    ...
    private List<FreeSlotItem> getData(int n){
        ...
        switch (n) {
            case 1:
                ...
                break;
            case 2:
                names = new String[]{"Rutanshu", "First Last Name", "First Last Name", "First Last Name", "First Last Name"};
                break;
            case 3:
                names = new String[]{"Rishabh", "Shashank", "First Last Name", "First Last Name", "First Last Name"};
                break;
            case 4:
