...
public class SFriFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootview=inflater.inflate(R.layout.sfrifrag,container,false);
        recyclerView1= (RecyclerView) rootview.findViewById(R.id.srfri);
        recyclerView2= (RecyclerView) rootview.findViewById(R.id.srfri2);
        recyclerView3= (RecyclerView) rootview.findViewById(R.id.srfri3);
        recyclerView4= (RecyclerView) rootview.findViewById(R.id.srfri4);
    ...
    private List<FreeSlotItem> getData(int n){
        ...
        switch (n) {
            case 1:
                ...
                break;
            case 2:
                names = new String[]{"Mayur", "First Last Name", "First Last Name", "First Last Name", "First Last Name"};
                break;
            case 3:
                names = new String[]{"Akhil", "Shashank", "First Last Name", "First Last Name", "First Last Name"};
                break;
            case 4:
