...
public class ThursFrag extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootview=inflater.inflate(R.layout.thursfrag,container,false);
        recyclerView1= (RecyclerView) rootview.findViewById(R.id.rthurs);
        recyclerView2= (RecyclerView) rootview.findViewById(R.id.rthurs2);
        recyclerView3= (RecyclerView) rootview.findViewById(R.id.rthurs3);
        recyclerView4= (RecyclerView) rootview.findViewById(R.id.rthurs4);
