...
public class FriFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootview=inflater.inflate(R.layout.frifrag,container,false);
        recyclerView1= (RecyclerView) rootview.findViewById(R.id.rfriday);
        recyclerView2= (RecyclerView) rootview.findViewById(R.id.rfri2);
        recyclerView3= (RecyclerView) rootview.findViewById(R.id.rfri3);
        recyclerView4= (RecyclerView) rootview.findViewById(R.id.rfri4);
