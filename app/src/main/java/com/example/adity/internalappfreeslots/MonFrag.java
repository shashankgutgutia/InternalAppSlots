...
public class MonFrag extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootview=inflater.inflate(R.layout.monfrag,container,false);
        recyclerView1= (RecyclerView) rootview.findViewById(R.id.rmon);
        recyclerView2= (RecyclerView) rootview.findViewById(R.id.rmon2);
        recyclerView3= (RecyclerView) rootview.findViewById(R.id.rmon3);
        recyclerView4= (RecyclerView) rootview.findViewById(R.id.rmon4);
