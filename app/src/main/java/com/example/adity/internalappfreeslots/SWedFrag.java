...
public class SWedFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootview=inflater.inflate(R.layout.swedfrag,container,false);
        recyclerView1= (RecyclerView) rootview.findViewById(R.id.srwed);
        recyclerView2= (RecyclerView) rootview.findViewById(R.id.srwed2);
        recyclerView3= (RecyclerView) rootview.findViewById(R.id.srwed3);
        recyclerView4= (RecyclerView) rootview.findViewById(R.id.srwed4);
